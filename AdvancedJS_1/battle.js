...
// const content = require(__dirname + "E:\\Intesab_Frameworks\\battle.js");
...
// console.log(battleData[1].attacker_outcome)

const outcome = battleData.map(item => item.attacker_outcome).filter((value , index , self) => self.indexOf(value) == index) 

const def_size =  battleData.map(item => item.defender_size).filter((value , index , self) => self.indexOf(value) == index) 



const type =  battleData.map(item => item.battle_type).filter((value , index , self) => self.indexOf(value) == index) 

// console.log(def_size)
// console.log(type)


const json_attackerOutcome = {
    'attacker_outcome':outcome,
    'battle_type':type,
    'defender_size':def_size
  
}
// console.log(json_attackerOutcome) 
